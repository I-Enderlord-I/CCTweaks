 ...
 * {@link org.squiddev.cctweaks.core.turtle.TurtleHooks#isBlockBreakable(World, int x, int y, int z, EntityPlayer)} instead of
 * {@link dan200.computercraft.ComputerCraft#isBlockEditable(World, int x, int y, int z, EntityPlayer)}.
 */
