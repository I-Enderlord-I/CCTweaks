...
public class PocketUpgrades implements IPatcher {
	...
	public ClassVisitor patch(String className, final ClassVisitor delegate) throws Exception {
		return new FindingVisitor(delegate, new TypeInsnNode(NEW, "dan200/computercraft/shared/pocket/apis/PocketAPI"),
				new InsnNode(DUP),
				new MethodInsnNode(INVOKESPECIAL, "dan200/computercraft/shared/pocket/apis/PocketAPI", "<init>", "()V",
						false),
				new MethodInsnNode(INVOKEVIRTUAL, "dan200/computercraft/shared/computer/core/ServerComputer", "addAPI",
						"(Ldan200/computercraft/core/apis/ILuaAPI;)V", false)) {
			@Override
