...
public interface ICustomRomItem {
	...
	/**
	 * Returns the color of the Disk it was crafted with.
	 * 
	 * @param stack The stack to get the color from.
	 * @return The color hex.
	 */
	int getOriginalColor(@Nonnull ItemStack stack);
	
	/**
	 * Sets the color of the Disk it was crafted with.
	 * Only use after crafting
	 * 
	 * @param stack The stack to set.
	 * @param hex	The color hex.
	 */
	void setOriginalColor(@Nonnull ItemStack stack, int hex);
}
